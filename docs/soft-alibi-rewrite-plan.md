...
- **Voice to retire:** the jargon noun "mid-want" (removed from all prose and labels on 2026-09-24; `tests/story-quality.test.js` now rejects it), "Soft alibi had become X", repeated "early thirties / mid-forties finance and tech holding" tags, and stacked anchor fragments ("Wine rings. Elevator chime. Black car.").
- **Stock closers removed:** the shared "Elevator chime trembled… She trembled choosing…" closers in 6a/7a/8c/9b/9d/9g and the "She arched, thighs tight…" line in 8f/8i/8l were stripped as padding on 2026-09-24. Those Hot versions now end on their previous paragraph and need a real closing beat.
