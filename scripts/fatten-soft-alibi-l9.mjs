#!/usr/bin/env node
/**
 * Fatten The Soft Alibi scene9a–scene9h to full Warm+Hot (≥1500 each).
 * Keeps stub ids/titles/choice IDs. Nolan-only; Crownspire; across-the-hall;
 * Brooks homicide interest; Vivienne four fates open into L10; zero other-title meta.
 */
import fs from "fs";
...
const WARM_PADS = [
  `Elevator chime late in the shaft reminded [player_name] that Crownspire never slept clean. Soft alibis lived in the gaps between floors—weekly to monthly to gone still contested, Vivienne's four fates still open doors behind every polite sentence. Layer 9 pressure made every hush sound like a draft Brooks could subpoena into colder paper without needing a settled body on the table.`,
  ...
  `Brooks's badge flash in the lobby had stopped sounding like missing-persons alone. The file was cooling toward something colder without requiring a corpse. Hope and dread shared the hallway. Vivienne might have left willingly, been paid to vanish, died, or staged every empty mark—[player_name] still could not choose which ending to fear, and Layer 9 refused to sole-lock any fate for her.`,
  `Nolan's brutal charm polished boardrooms and bedrooms with the same metal tell. Soft was what money bought when hard answers would burn the holding. [player_name]—early thirties, she/her, neighbor-mistress—felt the soft alibi fitting itself to her mouth like expensive silk she had not agreed to own, now wearing silent-partner ink, listening-wire aftertaste, hangar fuel, inquiry heat, and glass-dawn pressure.`,
  `Crownspire held its hush around her. Choice labels waited as verbs of consequence: stand as cover, mercy rewrite, open the silence, seal with Pell, name one fate thread, wait while he hunts, hospital dawn, glass dawn. Mid-want and rising law pressure braided until leaving either unfinished hurt enough to prove both were real. Soft alibi path, broadcast path, quiet deal, handler catch or escape—Layer 9 spent soft into sharper paper without settling Vivienne into a single L10 lock.`,
];

const HOT_PADS = [
  `Elevator chime trembled through [player_name]'s teeth and down into unfinished heat. Nolan's nearness turned every secret into a physical question—cufflink click as tell, perfume ghost as third heat, mid-want ending before climax because consequence still had names left to speak. Layer 9 made the unfinished louder.`,
