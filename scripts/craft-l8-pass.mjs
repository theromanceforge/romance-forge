...
[player_name]'s pulse lived between her legs and in the journal's warm spine. Remains still unnamed. Charm still only *like*. Will's thumb found her pulse at her wrist and counted like he was timing an orgasm he refused to give her on precinct concrete. "Verb," he said. "Before Ellison invents one."`
  },
  b: {
...
"Mercy leash means seals as sheath—Owen under a bargain-edged oath, some pages dark on purpose," Will said, voice low enough that the HVAC nearly ate it. "Clean burn means you testify fully anyway and teach this machine that some sisters refuse soft darkness even when a captain offers it as kindness. I stay human either way. Or I become the clearance fear she is already drafting."

[player_name] tasted burnt coffee and pier salt through the vents. Hope and dread still shared Cho's careful language upriver. Will's grey-green eyes asked for the verb while Ellison's reflection watched them in the rain-flecked glass like a woman who had already priced both doors and was waiting to see which one [player_name] would bleed for.`,
    h: `When Ellison turned for the call she had been pretending not to take, Will's hand found the inside of [player_name]'s wrist under the table edge—thumb on her pulse like a wire check and a claim. His boot hooked her ankle. The hard line of his cock pressed once against her knee through charcoal wool, honest and filthy and banked.
...
[player_name] pressed her thighs together until slick fabric dragged. Foghorn rolled. Will's grey-green eyes asked for the verb one last time while Ellison's reflection watched them like a third, uglier arousal. "Pick," he said. "Before she invents your spine for you."`
  },
  c: {
...
[player_name] traced Renny's loops once more with a fingertip that shook. Badge on the dresser. Cracked notebook on the floor. Unidentified remains still patient. Charm still only probable. The unfinished kiss of confession hung between their mouths—grief holy, want unfinished, two doors that both cost.`,
    h: `Will's thigh slotted higher between hers until the letter's cream edge crinkled against her sternum and her cunt answered the paper's honesty with a filthy pulse she refused to tidy. His mouth found her throat. His fingers found the wet edge of her underwear and kept time there—stroke, stop, stroke—like a man who understood mid-want was the only ending Harborwick ever earned.
...
The desk lamp threw yellow across his scar. [player_name] arched into the almost. Letter between them. Choice unfinished. Will's cock hard against her hip and denied on purpose while rain kept score on the glass.`
  },
  d: {
...
"Sealed pages means we wake beside smoke and a detective who held the bowl—file dark where Ellison cannot sand it soft, us living with what fire kept private," Will said, cracked knuckles still damp from the tap. "Pier dawn means we walk the boards where a festival ate a sister and ask whether leaving or staying is the cleaner burn. Both doors remember what you lit. Neither invents Renny on Cho's tray."

[player_name] tasted smoke at the back of her throat. Attraction sharpened around ruin without needing a second name for his sealed past. The bowl cooled. Harborwick's rain kept time on the glass while she chose sealed life or pier fog with ash still ghosting her tongue and Will waiting like a man who would not pretend fire was tidy.`,
    h: `Will boxed her against the counter while the bowl still ticked heat. His hand shoved into her jeans without ceremony—two fingers finding her shamefully slick from watching paper die—and he fucked the choice into her with kitchen patience, thumb on her clit, mouth at her ear.
...
[player_name] came close and was denied—Will easing out, painting her lower lip with a wet thumb, grey-green eyes wrecked and careful. The kitchen cooled enough to pretend the fire had only been paperwork. He waited. The bowl cooled. She had to pick sealed sheets or pier fog with smoke still in her cunt's memory.`
  ...
  e: {
    w: `Ellison's phone glowed *partner* again across the room and Will's jaw flexed once—old bruise, no speech. The second-victim file lay open like a throat that had finally learned a second name without christening Renny's.

"Widen into full trial testimony and every other girl's mark becomes vertebrae under oath," Will said, pen still. "Name Renny's killer when the clerk is caught and keep the lens narrow enough that hope still has a corridor upriver. I will not invent funerals to make a pattern prettier. I will not shrink a pattern to make your grief tidier."

Outside, pier fog argued with itself. Inside, [player_name] flexed her fingers against the desk edge and felt seven years braid into one next verb. Will watched her mouth the way he watched evidence that might burn him. Mid-want hung unfinished: widen the case, or keep the hunt named for one sister while science stayed patient.`,
    h: `Under the table Will's boot claimed her shoe and his knuckles brushed the inside of her knee—claim translated into denim heat. [player_name]'s cunt clenched around the pattern's ugly mercy: other girls' marks, Renny still a pointed finger, Cho still refusing baptism.

"Widen the trial and I fuck you after every deposition until pattern and orgasm stop pretending they are different grammars," Will murmured, voice for her alone. "Catch the clerk and make him name the killer with Renny still central—and I keep you aching in the van until the name lands, unfinished on purpose, because your body tells truth faster than Ellison's clearance mug."

His thumb found her pulse at her wrist and pressed. Ellison said *partner* wrong on purpose into the phone; Will's flinch traveled through that thumb into [player_name] until she bit her lip. Two doors. One wet. Science still unanswered upriver.`
  },
  f: {
    w: `The narrow file stayed narrow on purpose—Renny's name underlined twice, other marks living only as margin ghosts Ellison hated. Will's pen did not move. Grey-green eyes did.
...
Outside, pier fog argued. Inside, [player_name] felt seven years and one unfinished want braid into a verb. Will watched her mouth. The hook hung in Ellison's quiet and in his almost-touch and in the unanswered science that still refused to finish the naming while Harborwick's damp history leaned on the glass.`,
    h: `Will's knee pressed hers hard enough to bruise soft. Under the desk his fingers found the seam of her jeans and rubbed once—filthy punctuation on a narrow case—until [player_name]'s breath hitch betrayed her.
...
[player_name]'s palms dampened the desk. Attraction blasphemy wearing narrow clothing. Old-wound silence under Will's ribs like a second badge. Between her legs and the almost-touch of his attention, unanswered science upriver braided into one hook—ruin and rescue refused to share a template with any other fork. She had to pick.`
  },
  g: {
    w: `Sodium light leaked through corrugated gaps. The clerk's wrists shone. Warm shredder still ticked somewhere in the dark like a mechanical conscience. Will did not fill the silence with comfort.

"Hold the clerk—killer named—means we extract while steel is fresh and Renny's map stays geography not corpse," he said, notebook spine cracking. "Watch him slip—Will hunts—means you choose vigil over certainty and I spend dawn chewing restraint two blocks away. Both leave Cho's tray unnamed. Both leave my past stained if Ellison's radio silence means anything."
...
[player_name] drew a breath that tasted like rust and soap and unfinished trust. Attention as a blade laid flat. Dawn coming whether the clerk's cigarette brand matched Renny's margin sketch or not. Hold or hunt—mid-want still humming in the frost-latch dark.`,
    h: `Behind the frost-latch [player_name]'s thighs were tight enough to hurt. Will cleared the last angle, then crowded her for one stolen second—gloved hand at her waist, ungloved thumb stroking the damp heat through her jeans until she nearly made a sound the warehouse would own.
...
Perimeter radio crackled *partner* by accident; Will's small flinch traveled into her as heat she had no protocol for. Hold meant extraction and a name with teeth. Slip meant hunt and vigil. Charm still probability. Bones still unnamed. She had to conjugate dawn into a door.`
  },
  h: {
    w: `Owen's partial confession sat on the table like a fish that had learned to breathe air badly—dates, companions, lullaby grammar, living links without Renny christened on a tray. Ellison's empty mug watched. Will's notebook music stopped.

"Use Owen's partial to catch the clerk and we spend ugly usable truth as a net," Will said. "Trade mercy for what Owen gave and we sheath the worst edges while the desk codes still smoke. Both leave science patient. Both leave me wanting your mouth after cuffs for reasons that are not clearance."

Outside the glass, pier fog argued with itself in the reflection. Inside, [player_name] flexed her fingers and felt the next verb arrive without a soft land. Owen breathed deal-shaped fear. Will watched her mouth. Mid-want unfinished between mercy and steel.`,
    h: `Will's boot pressed her shoe once more under the interview table—claim, dare, unfinished fuck translated into leather—while Owen's cuffs ticked. [player_name]'s cunt answered the partial the way it answered Will's almost-kisses: shameless, procedural, wrong for the room and right for the week.

"Catch the clerk off Owen's dates and I put you on this table after transfer—fingers first, mouth second—until mercy and orgasm stop competing," Will murmured for her alone. "Trade mercy for the partial and I keep you dripping through the deal language because your body refuses to let bargain feel clean."

Ellison entered soft and final. Gaze cutting to Will's ribs—old flinch, not unpacking—and to the flush climbing [player_name]'s throat. Two doors. One wet. Renny still a pointed finger. Science still unanswered.`
  },
  i: {
    w: `The alcove smelled like bleach and victory that refused to feel clean. Mic pack still warm against [player_name]'s sternum. Marcus Hale's name still living on the wire like a second pulse. Will's cracked knuckles whitened when a hallway cart rattled—old bruise, no speech.

"Catch the clerk off the wire—lean hard, float backup, put Hale in a room before municipal paper rinses itself," Will said, inventory and hunger braided. "Carry this wire into full testimony—court lights, Ellison's narrative, chain on record—and stop pretending soft nets can hold a desk that already named itself. Both leave Cho's bones unnamed tonight. Both leave me wanting to put you somewhere soft after bleach."
...
[player_name] shook once. Soft was dead. The clerk's name was breathing. Fog pressed the glass. Hope kept its impossible job beside dread. The denial of his mouth on hers hung as the only soft thing left—and even that was a hook, not a landing.`,
    h: `Will pulled her into the alcove hard enough that the mic pack bit her sternum. Hands checked injury, then the wire, then shoved under her shirt onto bare ribs because alive was also sex and he refused to tidy it. Mouth on her jaw. Center kiss denied. Hand into jeans—two fingers pushing into heat that wire-success adrenaline had only made worse.
...
He fucked the choice into her with stakeout patience—curl, thumb on clit, forehead to hers—then eased out shining and painted her lower lip. Fog pressed the glass. Hale's name lived without a corpse attached. His cock still argued against denim. She had to pick before bleach invented a softer story.`
  ...
  j: {
    w: `Rain erased the curb where soft ice had just cut. The van smelled like wet wool and failed quiet. [player_name]'s mic pack sat against her sternum like a second mouth that had been caught mid-sentence. Will's scar nick was white; his late smile was gone.
...
The denial of his mouth hung unfinished. Soft was dead. The clerk was moving. Harborwick fog pressed the van glass and hope kept breathing beside dread while [player_name] chose vigil or volume with adrenaline still shaking her hands.`,
    h: `Will pulled her into the van—scar nick white, grey-green nearly black—hands checking injury, mic, then under her wet shirt onto bare ribs. Mouth on her jaw. Hand into jeans again, fingers pushing into heat that wire-fail adrenaline had only made worse.
...
He curled once, denied her the edge, wiped his fingers on her stomach like evidence. Fog pressed the glass. A blank line where Hale's full name should have been. His cock still argued. She had to conjugate aftermath into a door before the unfinished kiss became the only honest thing left.`
  ...
  k: {
    w: `Flashbulbs stuttered against Harborwick's damp throat. The SIM chain lived on a podium mic like a live wire that had learned to speak daylight. Will stood at [player_name]'s shoulder with brutal charm filed to a public edge and a sealed silence in his shoulders that did not need a second name.
...
He rolled his hips once—honest, filthy—and stopped, unfinished held like a vow. Flashbulbs stuttered. [player_name]'s cunt clenched around the public risk. Charm probable. Bones unnamed. She had to pick before the city invented a softer verb for her mouth.`
  ...
  l: {
    w: `The quiet-deal draft glowed on Ellison's tablet like a softer knife. Ink dimmed when Will closed the lid halfway—chain still alive underneath. Rain freckled the glass. [player_name] tasted toner and compromise.

"Seal what the quiet deal demands—pages dark, desks breathing, Renny's name protected from rinse-cycle optics," Will said. "Fold the deal into mercy testimony—bargain language walked into a room with oaths anyway. Both leave fog on the glass. Both leave me wanting to finish the almost-kiss this room keeps interrupting."
...
He closed the draft lid fully. The almost hung unfinished on purpose while Harborwick fog pressed and hope kept its impossible job beside dread on Cho's contested tray. [player_name] chose seal or fold with mid-want still conjugating in her throat.`,
    h: `Will guided her into the copy alcove, draft lid still half-closed on the table behind them like a third consent. Hand into her jeans. Two fingers. Thumb on clit. Mouth on her jaw—center denied.
...
He eased out shining. Fog pressed the glass. Chain still alive under dimmed ink. His cock still argued against denim. She had to pick before Ellison's tablet invented her spine.`
  ...
  m: {
    w: `Diesel and antiseptic braided in the ambulance bay. Gauze at Will's temple looked too small for how the red door had sounded. The medic's back was a temporary wall. Captain Mara Ellison's name already lived in someone's phone two blocks away—review weather coming whether they invited it or not.
...
[player_name] almost laughed. Almost cried. Trust under gauze. Mid-want unfinished between fluorescent future and diesel chase while Will's cracked knuckles stayed forced open on the rail like a man refusing to hold a gun and a lover with the same fist.`,
    h: `In the supply alcove Will put [player_name]'s back against saline shelves, blood-smear gauze brushing her temple when he kissed her hard enough to bruise. He dropped despite the throb, yanked her jeans, and put his mouth on her cunt like survival had a flavor—tongue fucking, nose on clit—until she shook and he denied the edge on purpose.
...
His thumb brushed her lower lip. Diesel. Fluorescent future. Wet jeans. Choice sitting between them like unfinished fucking—hospital dawn with his blood under gauze, or waiting while he hunted with her taste still in his mouth.`
  ...
  n: {
    w: `The recorder's red light made every breath look like evidence. Lieutenant Rhee's pen clicked. Ellison's folder sat thick enough to bruise. Will's jaw worked once when association weather brushed the sealed past—hint only, pressure without a dump—and then he returned to science shields: bones unnamed, charm probable, closeness not sandbagging.

"Build a future after IA—leave this room into hospital-dawn weather and soft partnership while Cho stays patient," Will murmured for [player_name] alone. "Carry the IA stand into Owen's trial—walk every sentence you fed Rhee into the next hard room where family pressure becomes docket. Both are hard rooms. One has better lighting. Neither invents a funeral for clearance."

Rain thickened on the high windows. Rhee waited. Ellison waited. Will waited like a sealed file that had learned to love a witness out loud. Mid-want unfinished between rebuild and docket.`,
    h: `In the recess copy room Will shoved [player_name] onto the low cabinet, dropped to a crouch, and ate her through the hearing's leftover adrenaline—toner smell, burnt coffee, his tongue filthy and precise—until she muffled a cry into her wrist. He rose shining, put her hand on his cock through his pants, and rolled once against her palm.
...
He was still tasting her. That was not in any memo yet. Grey-green eyes wrecked. She had to choose which room got their next hour—soft rebuild under rope, or docket weather with her stand still wet on his mouth.`
  ...
  o: {
    w: `Blinds taped. Phones facedown. Muted chyron of City Hall stuttered without sound. Takeout ginger cooled on the counter. Will checked the deadbolt like tenderness wearing habit's coat.
...
Outside, Harborwick shouted. Inside, soft held for one more fork. Will's grey-green gaze held hers, tired, hungry, unfinished. Mid-want between boards-and-geography and flashbulbs-again while rain thickened against taped glass like a second audience.`,
    h: `Will boxed her against the deadbolt, mouth at her ear, rolling his hips once against her bare slick so she felt exactly how unfinished he was. He had already had her on the counter—fingers, mouth, denial—and the room still smelled like sex and ginger and muted news.
...
His cracked knuckles traced her jaw. Either verb kept Renny a pointed finger. Either verb left Cho patient. Neither let him pretend hide-together cleaned him. The deadbolt waited. So did his mouth. So did the pier. So did the storm.`
  ...
  p: {
    w: `Lantern light found Renny's age-progressed maybe on a festival poster and refused to make it science. Boards remembered. Fog erased the far pilings. Will had offered truth instead of a ring—vow with pier salt, not jewelry.
...
A vendor's generator coughed near the lot—rhyme without accusation. [player_name] felt Will's notebook in his jacket like a small black heart. Mid-want unfinished between boards-with-honesty and inland gauze while festival noise dug softer than cameras and still dug.`,
    h: `In the crate pocket Will yanked her jeans and put his mouth on her under carnival sugar and sealed-past hum—tongue precise, denial cruel—then braced her against the plywood and rolled his hips once so she felt the unfinished claim through his pants.
