...
Marcus Pell preferred leverage. Rhea's ash preferred silence. Elevator chime far below. Black car. Wind sheer. Hope and dread on letterhead.

Internal shadow on a holding board was quieter than Brooks and somehow colder. Badge numbers without lobby flash meant stationery that could end careers and soft covers in the same memo. [player_name] read the number twice and felt across-the-hall geography become a line item.
...
Letterhead fear and Nolan-nearness want shared her bloodstream. Inquiry meant public closeness with private throb exposed. Silent-partner spend meant leverage with his eyes on her mouth.`,
  choices: [
      {
          "id": "scene7n",
          "text": "Accept inquiry heat on your closeness",
          "textHot": "Accept inquiry heat on your closeness while his nearness still unfinished you"
      },
      {
          "id": "scene7a",
          "text": "Weaponize silent-partner file before the badge number spends you",
          "textHot": "Weaponize silent-partner file while your body still aches toward Nolan under board light"
      }
  ]
};
