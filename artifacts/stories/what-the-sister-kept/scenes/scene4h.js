export default {
  ...
  layer: 4,
  title: "Hard Lean",
  text: `The vendor clammed up.

One minute Marta had been tapping ash and squinting at Renny's flyer; the next her face shuttered as if an interior lock had turned. A Harborwick Harbor Authority truck rolled past the pier chain-link, slow enough to look casual. Marta's cigarette hand paused. Her eyes flicked to William Akers' badge where his jacket had shifted, then to [player_name], then to the aluminum counter as if fryer grease had become the only safe country.

"I said what I said," Marta muttered. "Generator noise. Maybe an argument. Maybe I mixed festival nights. Girls argue. Men leave. Posters went up. I sell cakes. We done?"

Will's late smile arrived on cue—brutal, patient, the weapon half of him gleaming under pier fog light. Mid-thirties, dark stubble, hazel eyes cooling from hunger to something sharper. Scar nick at the eyebrow. Whitened knuckle flexing once on the notebook he did not close. Not clean-cut. Not safe. "Marta," he said softly, charm dialed to intimate threat. "You were doing so well. Warehouse. Clean jacket. Scared under angry. Do not sand it now because a truck rolled by with the wrong logo."

"I don't know warehouses." Her voice hardened. "I don't know jackets. I got a stall lease and a kid who needs me not talking to badges like we are friends."

[player_name] felt the lead slip like wet rope. She had steered Will here instead of naming Owen—festival witnesses first, stepfather ghosted—and now the witness was folding. Rain ticked the roof. Fried dough smell turned cloying. Somewhere upriver, unidentified remains waited; the charm in evidence remained only *like* Renny's. Hope and dread shared the trailer with a third guest: fear.

Will leaned both forearms on the counter, closing distance without raising volume. "I can come back with paperwork that makes your lease itch," he said, still smiling. "Or you can finish the sentence you started before the truck taught you manners. I am very good at returning. Ask anyone who has tried to clam up on me after a useful first paragraph."

Marta's mouth flattened. "That smile. My cousin said a detective smiled like that after a raid went to teeth. Solis. You want to lean, lean somewhere else."

The name landed. Nina Solis—bullpen rumor, Will's wound wearing charm for a face. His expression did not break. It narrowed. "Harborwick loves campfire stories," he murmured. "I love unfinished ones about missing girls. Renny Vale. Sixteen going on stubborn. Charm bracelet. Arguing by a generator. You do not get to take that back because authority paint drove past."

[player_name] touched Will's sleeve—light, warning, plea. "Will. Soft."

He did not look at her yet. "Soft is how we got seven quiet years and bones without a name." Then he glanced over, and the wound showed under the charm for a second—raid-debt, ashes, a lesson that had made him dangerous in a different register. "You brought me to witnesses. Witnesses sometimes need weight. I can lean harder. Or you can walk her out of my reach and we lose the paragraph. Your call will decide whether I become the bad cop in this trailer or you become the shield that keeps me from it."

Marta watched them like people deciding her weather. "I got nothing else," she insisted, weaker.

Will opened the notebook anyway, pen poised. "Height of the man. One more detail. A word Renny used. A direction she pointed. Give me scrap and I leave without leaning. Give me silence and I start making phone calls that do not care about funnel cakes."

The aluminum walls seemed to shrink. Fog horns groaned. [player_name]'s pulse hammered. She could step between them—become the soft voice, the family-shaped reason Marta might reopen—or she could refuse the theater, walk out, force Will to chase her instead of crushing a scared vendor for a half-memory that might name a warehouse or a badge.

Will's voice dropped further, almost kind. "I am not Ellison. I am not a clearance calendar. I am the man who still dreams in raid noise when soft nets fail. Nina Solis is a hint you do not get to hold. Renny is a sister you do. Help me choose which dream I feed tonight."

[player_name] tasted copper and sugar. The choice hurt already: shield him into better manners, or leave the trailer and let his lean become someone else's problem—knowing either path still left Owen unnamed and remains unidentified and William Akers looking at her like want and procedure had become the same blade.

Marta crushed the cigarette out harder than ash required. "You lean on me, detective, and I forget even the fog. That is not a bluff. Pier people know how to go blank."

Will's smile showed teeth. "Blank is a skill. So is memory recovery under pressure. I have used both. I prefer the version where nobody's lease burns and a missing girl's last argument still has edges." He finally angled his body to include [player_name] fully, hand finding the small of her back under her coat—claiming, steadying, threatening comfort. "She is Renny's sister. She asked me not to start with family throats. She asked for witnesses. You are the witness. Do not make a liar of her kindness."

The appeal was craft and manipulation braided. [player_name] hated how well it worked on her own spine. She hated more that she wanted his hand to stay. Dangerous attraction: a detective who could beg and threaten in the same breath, who carried a raid-wound named Solis like a hidden tooth, who made loyalty feel like standing too close to a heat lamp.

"Let me talk to her," [player_name] said quietly. "Without the badge voice."
...
Will did not look at the flyer. He looked at [player_name] the way he looked at unfinished files—hungry, careful, already measuring which pressure would break the right thing. "Shield me," he said, almost gentle. "Stand between my mouth and her lease. Soft voice. Soft body in the way of a hard lean." His scarred knuckles flexed once on the napkin stack. "Or walk out. Make me chase you into pier fog instead of teaching Marta how memory recovers under weight. Ellison wants clearance. I want a scrap that keeps Renny a living question. You get to decide which hunger I feed first."
...
"Marta," Will said softly, leaning in, voice warm enough to lick. "You were doing so well. Warehouse. Clean jacket. Scared under angry. Do not sand it because a truck taught you fear." His thigh pressed the counter edge; [player_name] stood close enough to feel the heat rolling off him, to smell rain and burnt coffee ghosts and the metallic edge of a man about to lean hard.
...
Marta watched them like a storm choosing a roof. "Blank is easy," she warned.

Will smiled with teeth. "Memory under pressure is easier for me." He steered [player_name] a half-step closer to the counter, using her body as part of the theater—sister as conscience, sister as heat. "She asked for witnesses instead of family throats. Do not make a liar of her. Give me height. A word. A direction. Then I take this dangerous woman outside and stop looking at your lease."

[player_name]'s breath stuttered. She could feel every inch of him through coats. "Let me talk to her," she whispered. "Without the badge voice."
...
The trailer held its breath. Fryer oil. Cigarette ghost. A notebook open to a half-line about a generator argument that might still save a sister who might still be among the unidentified—or might not. [player_name] took one step, then another, body aching, conscience loud, William Akers waiting like a door that stuck on purpose between mercy and lean. She tasted sugar and Will and the metallic bright of a choice that would not let her pretend the badge was only a badge.

Will's late smile did not soften when she hesitated. He backed her half a step toward the trailer wall where fryer heat had warped the paneling, thigh slotting between hers so her soaked seam rode muscle through jeans. Marta pretended the napkin stack needed arranging. [player_name] gasped into Will's collar; his cock pressed her hip, blunt proof that lean and lust shared a nervous system in him.
...
Fryer oil. Foghorn. A detective who had survived a raid and learned to hunt. She did not close the tab. She could not.`,
  choices: [
    { id: "scene5o", text: "Step in as shield — keep Will from leaning too hard", textHot: "Step in as shield — soft voice, body between Will and the lean" },
    { id: "scene5p", text: "Walk out of the interview — refuse the hard lean", textHot: "Walk out — make Will chase you instead of breaking her" }
  ]
};
